...
public class MemberOutList implements CommonExecute {
	...
	public void execute(HttpServletRequest request, HttpServletResponse response) {
		...
		int total_count = dao.getOutMemberCount(select,search); 
		...
		ArrayList<Member_dto> dtos = dao.memberOutList(select,search,start,end,t_desc);
