...
public class AdminStoreList implements CommonExecute {
	...
	public void execute(HttpServletRequest request, HttpServletResponse response) {
		...
		int total_count = dao.getStoreTotalCount("Y",select,search); 
		...
		//관리자가 허락한 가게목록
		ArrayList<Store_dto> adminListY = dao.AdminStoreListY(select,search,start,end,t_desc);
		

		String pageDisplay = CommonUtil.pageListPost(current_page, total_page, pageNumber_count);
		
		request.setAttribute("adminListY",adminListY);
