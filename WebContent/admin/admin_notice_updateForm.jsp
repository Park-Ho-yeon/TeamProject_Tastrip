...
<script type="text/javascript">
	...
	function goUpdate(no){
		...
		noti.t_gubun.value="noticeUpdate";
		noti.t_no.value=no;
		noti.method="post";
		noti.action="/Admin";
		noti.submit();
 ...
 <form name="admin">
    ...
    <div id="admin_list">
        ...
        <div class="manager_box">
            ...
            <input type="hidden" name="t_date" value="${today}">
            <div class="right_box">
                ...
                <table class="write_tbl">
                    ...
                    <tr>
                        <th>제목</th>
                        <td colspan="3">
                            <input type="text" name="t_title" onkeyup="titleCheck()" maxlength='50' value="${t_dto.getTitle()}">                            
                        </td>
                    </tr>
                    <tr>
                        <th>내용</th>
                        <td colspan="3">
                            <textarea name="t_content" onkeyup="contentCheck()" maxlength='1000'>${t_dto.getContent()}</textarea>
                        </td>
                    </tr>
                    <tr>
                        <th>작성자</th>
                ...
                <div class="btn_group">
                    ...
                    <input type="button" onclick="goUpdate('${t_no}')" value="저장">
                </div>
            </div>
            </form>
        </div>
